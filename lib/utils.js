...
export function colors() {
  return ['hsl(0deg, 0%, 21%)','#F6A6FF','#AFCBFF','#6EB5FF','#FCC2FF',"#ECD4FF",'#97A2FF',"#ACE7FF","#E7FFAC",'#FFCBC1','#FFCCF9',"#D5AAFF","#B5B9FF","#85E3FF","#F3FFE3","#FFBEBC","#FF9CEE","#A79AFF","#C4FAF8","#DBFFC6","#FFABAB","#FFB5E8","#B28DFF","#DCD3FF","#AFF8DB","#BFFCC6","#FFC9DE"]
}